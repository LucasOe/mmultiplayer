...
#endif
            ImGui::MenuItem("Metrics/Debugger", nullptr, &show_tool_metrics, has_debug_tools);
            ImGui::MenuItem("Debug Log", nullptr, &show_tool_debug_log, has_debug_tools);
            ImGui::MenuItem("ID Stack Tool", nullptr, &show_tool_id_stack_tool, has_debug_tools);
            ImGui::MenuItem("Style Editor", nullptr, &show_tool_style_editor);
            ImGui::MenuItem("About Dear ImGui", nullptr, &show_tool_about);
            ImGui::EndMenu();
        }
        ImGui::EndMenuBar();
    }
